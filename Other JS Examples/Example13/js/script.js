...
// divide the second element in each array by 5,000 so that the result
// is more manageable (it'll be the height of the word in pixels)
var list = tags.map(function (word) {
	return [word[0], Math.round(word[1] / 5000)];
});

// create word cloud
WordCloud(document.getElementById("cloud"), {list: list});

// function for click funcionality
var clicked = function (ev) {
	if (ev.target.nodeName === "SPAN") {
		// find the tag that was clicked
		var tag = ev.target.textContent;
		var clickedTag;
		// if some text was clicked, generate text for "details"
...
// add click functionality to the "cloud" div
