...
// format the data
var get_points = function get_points(source_array, filter_function) {
	var result = [];
...
window.onload = function () {
	Flotr.draw(
	    ...
	    // data is split by wind strength using the filter_function
	    // option in the get_points function
	    [{
        ...
        {
        	title: "Hurrican Katrina 2005: Course and Wind Strength",
        	grid: {
        		backgroundImage: "./gulf.png",  // add bg image
